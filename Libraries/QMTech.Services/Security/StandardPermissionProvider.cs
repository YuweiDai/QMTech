...
namespace QMTech.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord Managevenders = new PermissionRecord { Name = "Admin area. Manage venders", SystemName = "Managevenders", Category = "Customers" };
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[]
            {
                ...
                new DefaultPermissionRecord
                {
                    CustomerRoleSystemName = SystemCustomerRoleNames.venders,
                    PermissionRecords = new[]
                    {
                        AccessAdminPanel,
                        ManageProducts,
