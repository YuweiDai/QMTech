            ...
            return {
                ...
                link   : function (scope, elem, attrs, ctrls) {
                    ...
                    var doValidate = function () {
                        ...
                        //判断是否为原始值，如果是原始值则不进行验证，added by daiyuwei 20160410                       
                        if (attValues.value == attValues.defaultValue)
                            ngModelCtrl.$setValidity('w5cuniquecheck', isExists === false ? false : true);
                        else {
